...
var Mastodon = function () {
    ...
    _createClass(Mastodon, [{
        ...
        key: 'createOAuthApp',
        value: function createOAuthApp(url) {
        ...
        value: function getAuthorizationUrl(clientId, clientSecret, baseUrl) {
        ...
        key: 'getAccessToken',
        value: function getAccessToken(clientId, clientSecret, authorizationCode, baseUrl) {
            var redirectUri = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'urn:ietf:wg:oauth:2.0:oob';
